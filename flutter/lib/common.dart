...
class MyTheme {
  ...
  static const Color accent50 = Color(0x77059669);
  static const Color accent80 = Color(0xAA059669);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFF0D9B6A);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF065F46);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF10B981);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Color(0xFF059669), secondary: accent, background: grayBg),
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://xyremote.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
